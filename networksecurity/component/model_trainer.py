...
from networksecurity.util.main_util.utils import save_preprocess_array,load_object,load_numpy_array_data,evaluate_models
import os
import sys
from networksecurity.util.ml_utils.metric.classfication_metrics import get_classification_score
...
class ModelTrainer:
    ...
    def train_model(self,x_train,y_train,x_test,y_test):
        ...
        save_preprocess_array(self.model_trainer_config.trained_model_file_path,obj=network_model)
        ...
        model_trainer_artifact=ModelTrainingArtifact(trained_model_file_path=self.model_trainer_config.trained_model_file_path,
                               trained_metric_artifact=classfication_train_metric,
                               test_metric_artifact=classfication_test_metric)
        logging.info(f"model trainer artifact:{model_trainer_artifact}")                       
        return model_trainer_artifact


    def inititate_model_trainer(self)->ModelTrainingArtifact:
        try:
